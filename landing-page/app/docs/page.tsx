export default function DocsPage() {
    ...
    <div className="space-y-16">
      ...
      <section id="getting-started" className="scroll-mt-24 space-y-6">
        ...
        <p className="text-gray-400 leading-relaxed">
          ...
          CLI tool handles everything from project structure to smart contract
          integration.
        </p>
      ...
      <section id="navigation" className="scroll-mt-24 space-y-6">
        ...
        <p className="text-gray-400">
          Your generated project follows a strict monorepo-friendly structure
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="border border-white/10 rounded-xl p-6 bg-white/5">
            ...
            <p className="text-sm text-gray-400">
              Contains all your Clarity smart contracts. Each template (Counter,
              Token, NFT) generates its own file/folder here.
            </p>
          </div>
          <div className="border border-white/10 rounded-xl p-6 bg-white/5">
            <h3 className="font-bold text-white mb-2">frontend/</h3>
            <p className="text-sm text-gray-400">
              The Next.js, React, or Vue application. Contains your pages,
          ...
          <div className="border border-white/10 rounded-xl p-6 bg-white/5">
            ...
            <p className="text-sm text-gray-400">
              Vtest + Clarinet SDK tests for your smart contracts. Run with{" "}
          ...
          <div className="border border-white/10 rounded-xl p-6 bg-white/5">
            ...
            <p className="text-sm text-gray-400">
              Configuration for the Stacks blockchain environment and contract
              dependencies.
            </p>
          </div>
        </div>
      ...
      <section id="hooks" className="scroll-mt-24 space-y-8">
        <div>
          ...
          <p className="text-gray-400 mb-6">
            We include pre-built hooks for common Stacks interactions. These are
            designed to be plug-and-play but easily customizable. Find them in{" "}
            <code className="text-stacks-orange bg-white/5 px-2 py-1 rounded">
              frontend/hooks/
            </code>
            .
          </p>
  ...
  return { call };
      ...
      <section id="features" className="scroll-mt-24 space-y-6">
        ...
        <p className="text-gray-400">
          Explore the full capabilities of Create Stacks App on our landing
          page.
        </p>
        ...
        <div className="flex gap-4">
          <a
            href="/#features"
            className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 rounded-lg text-sm font-bold transition-colors"
          >
            View All Features
          </a>
          <a
            href="/#templates"
            className="inline-flex items-center gap-2 px-6 py-3 bg-transparent border border-white/20 hover:border-white/40 rounded-lg text-sm font-bold transition-colors"
          >
            Browse Templates
          </a>
        </div>
      ...
      <div className="border-t border-white/10 pt-12 mt-12">
        <p className="text-gray-500 text-sm">
          ...
          <a href="#" className="text-stacks-orange hover:underline">
            Discord
          </a>{" "}
          community.
        </p>
