          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-12">
                ...
                <a
                  href="/docs"
                  className="bg-gray-900 text-white border border-gray-800 px-6 py-3 rounded-full font-bold hover:bg-gray-800 transition-colors text-sm flex items-center"
                >
                  View Documentation
                </a>
              </div>
              ...
              <div className="flex items-center gap-4 justify-center lg:justify-start text-sm text-gray-500">
                <div className="flex -space-x-2">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-gray-800 border border-black"
                    />
                  ))}
                </div>
              ...
              <div className="p-6 font-mono text-sm leading-relaxed">
                ...
                <div className="space-y-2 text-gray-400">
                  <motion.div
                    ...
                    transition={{ delay: 1 }}
                  >
                    <span className="text-blue-400">?</span> Project name:{" "}
                    <span className="text-white">my-dapp</span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  >
                    <span className="text-blue-400">?</span> Frontend framework:{" "}
                  ...
                  <motion.div
                    ...
                    transition={{ delay: 2 }}
                  >
                    <span className="text-blue-400">?</span> Smart contracts:{" "}
                    <span className="text-white">Counter, Token, NFT</span>
                  </motion.div>
